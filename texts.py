...
MESSAGES: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "api_error_hit": "⚠️ Клод упёрся в {kind} API — ответ может задержаться. Можно сменить модель: /model",
    ...
    "en": {
        ...
        "api_error_hit": "⚠️ Claude hit an API {kind} — the reply may be delayed. You can switch model: /model",
