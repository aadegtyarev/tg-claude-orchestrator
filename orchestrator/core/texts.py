...
MESSAGES: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "bubble_esc": "⛔ Прервать",
        "bubble_bg": "⏬ В фон",
        "bubble_backgrounded": "⏬ Задача отправлена в фон (Ctrl+B)",
        "bg_requested": "Отправляю задачу в фон (Ctrl+B)…",
    ...
    "en": {
        ...
        "bubble_bg": "⏬ Background",
        "bubble_backgrounded": "⏬ Task sent to background (Ctrl+B)",
        "bg_requested": "Sending task to background (Ctrl+B)…",
